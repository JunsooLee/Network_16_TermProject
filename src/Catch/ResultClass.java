...
public class ResultClass  extends JFrame implements ActionListener{
	...
	public ResultClass(int user1, int user2 ,String u11,String u22) {
		...
		u1.setFont(new Font("怨좊뵓" ,100,30));
		u1.setSize(100,40);
		u2.setFont(new Font("怨좊뵓",100,30));
		u2.setSize(100,40);
	...
	public ResultClass(int user1 , int user2 , int user3 ,String u11,String u22, String u33){
		...
		u1.setFont(new Font("�꽌�슱�븳媛뺤껜 EB" ,100,30));
		u1.setSize(100,40);
		u2.setFont(new Font("�꽌�슱�븳媛뺤껜 EB",100,30));
		u2.setSize(100,40);
		u3.setFont(new Font("�꽌�슱�븳媛뺤껜 EB",100,30));
		u3.setSize(100,40);
	...
	public ResultClass(int user1 , int user2 , int user3 , int user4 ,String u11,String u22,String u33,String u44){
		...
		u3.setFont(new Font("�꽌�슱�븳媛뺤껜 EB",100,30));
		u3.setSize(100,40);
		u4.setFont(new Font("�꽌�슱�븳媛뺤껜 EB",100,30));
		u4.setSize(100,40);
